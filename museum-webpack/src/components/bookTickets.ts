function bookTickets() {
  ...
  const basicTickets = document.querySelector('#basic-input') as HTMLInputElement;
  const seniorTickets = document.querySelector('#senior-input') as HTMLInputElement;
  const ticketsTotal = document.querySelector('.booking__data-total');
  const reservationBasic = document.querySelector('.reservation__basic') as HTMLInputElement;
  const reservationSenior = document.querySelector('.reservation__senior') as HTMLInputElement;
  const overviewBasic = document.querySelector('.tickets-number_basic') as HTMLInputElement;
  const overviewSenior = document.querySelector('.tickets-number_senior') as HTMLInputElement;
  const typeSelect = document.querySelector('.reservation__select') as HTMLSelectElement;
  const reservationDate = document.querySelector('.reservation__date') as HTMLInputElement;
  const reservationTime = document.querySelector('.reservation__time') as HTMLInputElement;
  const overviewDateOutput = document.querySelector('.overview__date-output') as HTMLInputElement;
  const overviewTimeOutput = document.querySelector('.overview__time-output') as HTMLInputElement;
  const overviewTypeOutput = document.querySelector('.overview__type-output') as HTMLInputElement;
  const overviewTotalBasic = document.querySelector('.tickets-cost-basic') as HTMLInputElement;
  const overviewTotalSenior = document.querySelector('.tickets-cost-senior') as HTMLInputElement;
  const overviewTotalSum = document.querySelector('.overview__total-sum') as HTMLInputElement;
  ...
  function calculateTotal() {
    ...
    const totalSum = (+basicTickets.value * BASIC_BENEFIT + +seniorTickets.value * SENIOR_BENEFIT) * type;
  ...
  function setReservationData() {
    ...
    (document.querySelectorAll('.overview__basic-price') as NodeListOf<HTMLElement>).forEach((i) => {
      i.innerText = String(type * BASIC_BENEFIT);
    });

    (document.querySelectorAll('.overview__senior-price') as NodeListOf<HTMLElement>).forEach((i) => {
  ...
  function updateData() {
    ...
    overviewTotalSum.value = `${(BASIC_BENEFIT * +reservationBasic.value + SENIOR_BENEFIT * +reservationSenior.value) * type} €`;
